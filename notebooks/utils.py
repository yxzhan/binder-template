...
def display_desktop(sub_path="desktop", in_sidecar=True, anchor="split-right", width="100%", height="100%"):
    """
    ...
    html_wrapper = HTML(f"""
        ...
        <div class="iframe-widget" style="width: calc({width});height:{height};">
            <iframe src="{remote_desktop_url}" width="100%" height="100%" style="border:0;"></iframe>
        </div>
